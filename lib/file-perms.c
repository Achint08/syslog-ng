...
void
file_perm_options_inherit_from(FilePermOptions *self, FilePermOptions *from)
{
  if (self->file_uid == -1)
...
void
file_perm_options_inherit_dont_touch(FilePermOptions *self)
{
  FilePermOptions dont_touch =
  {
    .file_uid = -1,
    .file_gid = -1,
    .file_perm = -1,
  ...
  file_perm_options_inherit_from(self, &dont_touch);
}
